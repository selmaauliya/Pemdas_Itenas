...
for index, row in df.iterrows():
    df.at[index, 'Gaji_setelah_peningkatan'] = row['Gaji'] * 1.05


df['Gaji_setelah_peningkatan_kedua'] = df['Gaji_setelah_peningkatan']

 
for index, row in df.iterrows():
    if row['Usia'] > 30:
        df.at[index, 'Gaji_setelah_peningkatan_kedua'] = (lambda x: x * 1.02)(row['Gaji_setelah_peningkatan'])
